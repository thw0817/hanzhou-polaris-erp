...
状态：未来实施路线草案；ERP-00～ERP-23 全部尚未开始  
...
> **重要校正：** ERP-00～ERP-23 是在 17 个板块方案完成后编制的未来工程实施路线，不是旧“第 1～20 步”的改名版，也不是已经执行过的步骤。截止本次校正，24 个 ERP 步骤全部为 `NOT_STARTED`。新对话不得因为阅读本计划就自动开始 ERP-00；应先理解 17 个板块方案，由用户确认采用本路线、修订路线或指定板块后，才建立正式 ERP Run。
